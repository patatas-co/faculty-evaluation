...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderProfile() {
        ...
        <div style="background:#fff;border:1px solid #e9eef6;border-radius:16px;padding:0;margin-top:20px;overflow:hidden;">
            <button type="button" id="toggle-password-section" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:20px 28px;background:none;border:none;font-family:inherit;cursor:pointer;font-size:1rem;font-weight:700;color:#111826;">
                Change Password
                ...
                students.forEach(s => {
                    ...
                    <div class="student-list-item">
                        ...
                        <div>
                            ...
                            ${s.student_number ? `<div class="student-list-email">${esc(s.student_number)}</div>` : ''}
                        </div>
                    </div>`;
                });
